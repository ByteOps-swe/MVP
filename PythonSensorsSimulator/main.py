...
symExec = (
    ...
    .add_temperature_simulator([writeToKafkaTemp], 45.388214, 11.691271,"Murelle", 0.5)
    .add_temperature_simulator([writeToKafkaTemp], 45.348214, 11.751271,"Montegrotto", 0.5)
    .add_temperature_simulator([writeToKafkaTemp], 45.368214, 11.951271,"Montegrotto", 0.5)

    .add_humidity_simulator([writeToKafkaUmd], 45.301214, 11.789271,"Arcella", 1)
    .add_humidity_simulator([writeToKafkaUmd], 45.291214, 11.787271,"Montegrotto", 1)

    .add_chargingStation_simulator([writeToKafkaChargingStation], 45.39214, 11.859271,"Arcella", 20)
    .add_chargingStation_simulator([writeToKafkaChargingStation], 45.40214, 11.959271,"Montegrotto", 20)
