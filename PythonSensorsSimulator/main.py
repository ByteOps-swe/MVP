...
symExec = (
    symExecAggregator
    .add_temperature_simulator([writeToKafkaTemp,list_writer], 45.398214, 11.851271,"Arcella", 0.01)
    .add_temperature_simulator([writeToKafkaTemp,list_writer], 45.388214, 11.691271,"Murelle", 0.01)
    .add_temperature_simulator([writeToKafkaTemp,list_writer], 45.348214, 11.751271,"Montegrotto", 0.01)
    .add_temperature_simulator([writeToKafkaTemp,list_writer], 45.368214, 11.951271,"Montegrotto", 0.01)

    .add_humidity_simulator([writeToKafkaUmd,list_writer], 45.301214, 9.85271,"Arcella", 1)
    .add_humidity_simulator([writeToKafkaUmd,list_writer], 45.201214, 9.85271,"Montegrotto", 1)

    .add_chargingStation_simulator([writeToKafkaChargingStation,list_writer], 45.39214, 11.859271,"Arcella", 20)
    .add_chargingStation_simulator([writeToKafkaChargingStation,list_writer], 45.79214, 11.959271,"Montegrotto", 20)

    .add_ecologicalIsland_simulator([writeToKafkaEcologicalIsland,list_writer], 45.331214, 11.8901271,"Montegrotto", 4)
    .add_ecologicalIsland_simulator([writeToKafkaEcologicalIsland,list_writer], 45.291214, 11.901271,"Murelle", 4)

    .add_waterPresence_simulator([writeToKafkaWaterPresence,list_writer], 45.591214, 11.879001271,"Murelle", 1)
