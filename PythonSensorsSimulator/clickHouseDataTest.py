...
async def test_1_misurazione(clickhouse_client):
    try:
        ...
        misurazione = AdapterMisurazione(Misurazione('2024-02-28 10:20:37.206573', 17, "Temperature", Coordinate(45.39214, 11.859271), "Tmp1", "Arcella1"))
        kafka_writer.write(misurazione) 
        kafka_writer.flush_kafka_producer()
        result = clickhouse_client.query('SELECT * FROM innovacity.temperatures where value =17 LIMIT 1')
        print(result.result_rows[0][3])
