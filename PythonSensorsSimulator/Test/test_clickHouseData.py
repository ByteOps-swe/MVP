...
async def test_1_misurazione(clickhouse_client):
    try:
        ...
        misurazione = AdapterMisurazione(
            Misurazione('2021-02-28 10:20:37.206573', 4001, "Temperature", Coordinate(45.39214, 11.859271), "Tmp1", "Arcella1"))
...
async def test_2_misurazione(clickhouse_client):
    try:
        ...
        for i in range(num_messages):
            misurazione = AdapterMisurazione(
                            Misurazione(f'2020-02-28 10:20:37.1{i}', 5001 + i, "Temperature", Coordinate(45.39214, 11.859271), "Tmp1", "ArcellaTest"))
            kafka_writer.write(misurazione)
        kafka_writer.flush_kafka_producer()
        time.sleep(10)
